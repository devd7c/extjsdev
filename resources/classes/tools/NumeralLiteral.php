        ...
        if((int)$dec>2 && ($numero%100)%10)$espacio=" y ";
         ...
         $unid=($numero%10);
          if ($unid>0) {
            ...
            return $centenas[$cent-1]." ".$decenas[$dec-2].$espacio;
          }
          //echo  $centenas[$cent-1]." ".$decenas[$dec-2].$espacio.$unidades[$unid==0?$unid:$unid-1];
  ...
  private function nrosRaros($raros)
  {
    ...
    private function armado($arreglo)
    {
      ...
      for ($i=$contador;$i>0;$i--)
      {
          ...
          $momentaneo[] =$this->posiciones($arreglo[$i-1],$i,$arreglo[$i-1]);
        }

      for($h=0;$h<$contador;$h++)
      {
         $literal.=$momentaneo[$h]." ";
      }
      if($this->decimal!=0)
      {
